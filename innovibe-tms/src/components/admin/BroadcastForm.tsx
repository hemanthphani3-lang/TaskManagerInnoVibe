...
import { Loader2, Megaphone, Send, Eye } from "lucide-react"
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 p-6 md:p-8">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Broadcast Announcement</h2>
          <p className="text-sm text-slate-500">Send a notification to employees and departments.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          >
            <option value="ALL">Everyone (Departments & Employees)</option>
