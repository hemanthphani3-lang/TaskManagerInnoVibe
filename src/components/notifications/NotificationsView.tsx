...
export function NotificationsView() {
  ...
  useEffect(() => {
    ...
    // Realtime Subscription with a unique channel name to prevent duplicate subscription errors
    const channelName = `realtime_notifications_${Math.random().toString(36).substring(2, 9)}`
