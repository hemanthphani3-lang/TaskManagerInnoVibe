...
export function RealtimeLeaderboard({
  ...
  useEffect(() => {
    // Subscribe to productivity_scores changes with a unique channel name
    const channelName = `leaderboard_${departmentId}_${Math.random().toString(36).substring(2, 9)}`
